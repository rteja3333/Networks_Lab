...
int main(int argc, char *argv[]) {
        ...
        if (strncmp(buffer, "HELO", 4) == 0) {
            ...
            do {
                ...
                int bytes_received ;
                    ...
                    //     break;
                    // }
                    // If not, continue receiving more data

                // At this point, the buffer contains the complete message ending with "\r\n"
    ...
    // Last part of the string is not "\r\n.\r\n"
            printf("out of whilke\n");
